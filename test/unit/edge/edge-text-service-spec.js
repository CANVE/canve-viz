...
describe('EdgeTextService', function() {
  ...
  describe('lengthBetweenPoints', () => {

    it('Returns length between two points', () => {
      // Given
      let sourceX = 1,
        sourceY = 4,
        targetX = 4,
      ...
      // When
      let result = edgeTextService.lengthBetweenPoints(sourceX, sourceY, targetX, targetY);

      // Then
      expect(result).toEqual(5);
    });

    it('Returns same length between when points are reversed', () => {
      // Given
      let sourceX = 4,
        sourceY = 0,
        targetX = 1,
    ...
    it('Returns same length when y runs in opposite direction', () => {
      // Given (assuming svg height of 4)
      let sourceX = 1,
        sourceY = 0,
        targetX = 4,
        targetY = 4;
